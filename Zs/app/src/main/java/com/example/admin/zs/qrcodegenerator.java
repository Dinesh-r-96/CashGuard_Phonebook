...
public class qrcodegenerator extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv = (ImageView) findViewById(R.id.qiv);
        etqr = (EditText) findViewById(R.id.qetqr);
        btn = (Button) findViewById(R.id.qbtn);
        Intent i=getIntent();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_qrcodegenerator, menu);
        return true;
    }
